...
if NS:IsSameLocale("deDE") then
    ...
    L["BEST_RUN"] = 	"Beste Mythisch+"
    L["BEST_RUNS"] = 	"Beste Mythisch+ per Dungeon"
    ...
    L["DUNGEON_NAME_LOWR"] = 	"Untere Rückkehr nach Karazhan"
    L["DUNGEON_NAME_COEN"] = 	"Kathedrale der Ewigen Nacht"
    L["DUNGEON_NAME_UPPR"] = 	"Obere Rückkehr nach Karazhan"
	...
	L["YOUR_RANK_UNK"] =	"Schließe einen beliebigen Schlüsselstein ab, um eine Wertung zu erhalten"
